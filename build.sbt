...
lazy val twitter4jDependencies = Seq (
  "org.twitter4j" % "twitter4j-core" % "4.0.4"
)

lazy val gsonDependencies = Seq (
...
.settings(libraryDependencies ++= (testDependencies ++ cassandraDependencies ++ sparkDependencies ++ twitter4jDependencies ++ gsonDependencies ++ mongoDependencies ++kafkaDependencies))
